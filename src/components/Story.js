...
const Story = () => {
  return (
    <div className=" mx-auto pt-20">
      <div className=" px-[10px] md:min-h-[600px] grid md:grid-rows-3 grid-flow-row md:grid-flow-col gap-4 pb-8 ">
      <h1 className=" text-4xl md:text-6xl md:col-span-2 font-frijole flex items-center justify-center">
    Our Story
  </h1>
        <div className="w-[80%]  mx-auto text-center text-[18px] md:text-[20px]   xl:text-[30px] order-last md:order-none md:row-span-2 md:col-span-2">
          <p>
      ...
      <div className="mx-auto flex justify-center items-center rounded-3xl sm:min-w-[50px] md:min-w-[100px] lg:min-w-[600px]  md:row-span-3 ">
        ...
        <Image src={"/assests/load.gif"} unoptimized  width={0}
            height={0}
            className="w-[200px] md:w-[450px] rounded-3xl md:h-[550px]     rounded-4xl " alt="" />
      </div>
      <h1 className="text-center font-frijole  text-4xl md:text-6xl md:col-span-2 md:order-none order-first flex items-center justify-center">Our Exictables</h1>
      <div className="w-[80%]  mx-auto  text-center text-[18px] md:text-[20px]   xl:text-[30px] order-last md:order-none md:row-span-2 md:col-span-2">
        <p>
      ...
      <div className=" px-[10px] md:min-h-[600px] grid md:grid-rows-3 grid-flow-row md:grid-flow-col gap-4 pb-8 ">
      <h1 className="text-center font-frijole text-4xl md:text-6xl  md:col-span-2 flex items-center justify-center">
    Our USP
  </h1>
        <div className="w-[80%] mx-auto text-center text-[18px] md:text-[20px]   xl:text-[30px]  order-last md:order-none md:row-span-2 md:col-span-2">
          <p>
